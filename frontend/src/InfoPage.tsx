...
const InfoPage: React.FC<InfoPageProps> = ({ onClose }) => {
  return (
    <Paper
      sx={{ p: { xs: 2, sm: 3, md: 4 }, mt: 4, borderRadius: 2, boxShadow: 3 }}
    >
      <Box
        sx={{
          display: 'flex',
      ...
      <Typography paragraph>
        Detta system är designat för att underlätta hanteringen av
        tävlingsavgifter för IFK Göteborg Orientering. Målet är att automatisera
        och förenkla processen från det att medlemmar deltar i tävlingar till
        dess att korrekta faktureringsunderlag skapas, både för vad medlemmen
        själv ska betala och vad klubben eventuellt täcker.
      </Typography>
      ...
      <List>
        ...
        <ListItem>
          ...
          <ListItemText
            primary='Steg 2: Exportera Fakturaunderlag (CSV)'
            secondary="Under fliken 'Fakturaunderlag' kan du exportera en CSV-fil anpassad för import till Fortnox. Här finns två val: 'Exportera för Fortnox' (innehåller endast poster som ska faktureras) och 'Exportera komplett underlag' (innehåller alla poster för avstämning)."
          />
        </ListItem>
        <ListItem>
          <ListItemIcon>
          ...
          <ListItemText
            primary='Steg 3: Ladda upp Fakturor (Frivilligt)'
      ...
      <Typography component='div'>
        <ul>
          <li>
            Systemet är beroende av korrekt formaterade indatafiler från
            Eventor.
          </li>
          <li>
            Regelmotorn är flexibel men dess korrekthet beror på hur reglerna är
            definierade och underhållna.
          </li>
          <li>
            Vid omberäkning efter regeländring används alltid den senast
            bearbetade deltagarfilen. Om du vill använda en annan fil måste du
            starta om processen och ladda upp den på nytt.
          </li>
        </ul>
      </Typography>
